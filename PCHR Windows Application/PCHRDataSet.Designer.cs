...
namespace PCHR_Windows_Application.PCHRDataSetTableAdapters {
...
SELECT PATIENT_ID, ALLERGY_ID, ALLERGEN, ONSET_DATE, NOTE FROM ALLERGY_TBL WHERE (ALLERGY_ID = @ALLERGY_ID) AND (PATIENT_ID = @PATIENT_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PCHR_Windows_Application.Properties.Settings.Default.PHCRConnectionString;
        }
